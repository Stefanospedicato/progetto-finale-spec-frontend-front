...
const Favorites = () => {
  ...
  return (
    <div className='container my-5 car-details'>
      <h1 className='text-center my-5'>LE TUE SCELTE</h1>
      <div className='d-flex flex-wrap justify-content-around'>
        {favorites.length > 0 ? (
          favorites.map(car => (
            <div key={car.id} className='favorite-card text-center col-12 d-flex justify-content-between'>
              ...
              <div>
                ...
                <div className='d-flex'>
                  ...
                  <button className='btn btn-dark m-2' onClick={() => toggleFavorite(car)}>Rimuovi dalle tue scelte</button>
                </div>
              </div>
            </div>
          ))
